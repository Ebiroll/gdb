...
host_vendor=build_pc
host_os=linux-gnu
host=x86_64-build_pc-linux-gnu
target_alias=xtensa-esp32-elf
target_vendor=esp32
target_os=elf
target=xtensa-esp32-elf

program_transform_name = s&^&xtensa-esp32-elf-&
...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --without-guile --host=x86_64-build_pc-linux-gnu --target=xtensa-esp32-elf

tooldir = ${exec_prefix}/xtensa-esp32-elf
build_tooldir = ${exec_prefix}/xtensa-esp32-elf
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--without-guile' --program-transform-name='s&^&xtensa-esp32-elf-&' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  intl libiberty opcodes bfd readline zlib libdecnumber sim gdb etc
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  '--without-guile' --program-transform-name='s&^&xtensa-esp32-elf-&' --disable-option-checking
...
TARGET_SUBDIR = xtensa-esp32-elf
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib --with-cross-host=x86_64-build_pc-linux-gnu   '--without-guile' --program-transform-name='s&^&xtensa-esp32-elf-&' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
AS = x86_64-build_pc-linux-gnu-as
AR = x86_64-build_pc-linux-gnu-ar
AR_FLAGS = rc
CC = gcc
CXX = g++
DLLTOOL = x86_64-build_pc-linux-gnu-dlltool
LD = x86_64-build_pc-linux-gnu-ld
LIPO = x86_64-build_pc-linux-gnu-lipo
NM = x86_64-build_pc-linux-gnu-nm
OBJDUMP = x86_64-build_pc-linux-gnu-objdump
RANLIB = true
READELF = x86_64-build_pc-linux-gnu-readelf
STRIP = true
WINDRES = x86_64-build_pc-linux-gnu-windres
WINDMC = x86_64-build_pc-linux-gnu-windmc
...
AR_FOR_TARGET=/home/olof/esp/xtensa-esp32-elf/bin/../lib/gcc/xtensa-esp32-elf/5.2.0/../../../../xtensa-esp32-elf/bin/ar
AS_FOR_TARGET=/home/olof/esp/xtensa-esp32-elf/bin/../lib/gcc/xtensa-esp32-elf/5.2.0/../../../../xtensa-esp32-elf/bin/as
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) xtensa-esp32-elf-cc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) xtensa-esp32-elf-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) xtensa-esp32-elf-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) xtensa-esp32-elf-c++
GCJ_FOR_TARGET=$(STAGE_CC_WRAPPER) xtensa-esp32-elf-gcj
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) xtensa-esp32-elf-gfortran
GOC_FOR_TARGET=$(STAGE_CC_WRAPPER) xtensa-esp32-elf-gccgo
DLLTOOL_FOR_TARGET=xtensa-esp32-elf-dlltool
LD_FOR_TARGET=/home/olof/esp/xtensa-esp32-elf/bin/../lib/gcc/xtensa-esp32-elf/5.2.0/../../../../xtensa-esp32-elf/bin/ld

LIPO_FOR_TARGET=xtensa-esp32-elf-lipo
NM_FOR_TARGET=/home/olof/esp/xtensa-esp32-elf/bin/../lib/gcc/xtensa-esp32-elf/5.2.0/../../../../xtensa-esp32-elf/bin/nm
OBJDUMP_FOR_TARGET=/home/olof/esp/xtensa-esp32-elf/bin/../lib/gcc/xtensa-esp32-elf/5.2.0/../../../../xtensa-esp32-elf/bin/objdump
OBJCOPY_FOR_TARGET=/home/olof/esp/xtensa-esp32-elf/bin/../lib/gcc/xtensa-esp32-elf/5.2.0/../../../../xtensa-esp32-elf/bin/objcopy
RANLIB_FOR_TARGET=/home/olof/esp/xtensa-esp32-elf/bin/../lib/gcc/xtensa-esp32-elf/5.2.0/../../../../xtensa-esp32-elf/bin/ranlib
READELF_FOR_TARGET=xtensa-esp32-elf-readelf
STRIP_FOR_TARGET=/home/olof/esp/xtensa-esp32-elf/bin/../lib/gcc/xtensa-esp32-elf/5.2.0/../../../../xtensa-esp32-elf/bin/strip
WINDRES_FOR_TARGET=xtensa-esp32-elf-windres
WINDMC_FOR_TARGET=xtensa-esp32-elf-windmc
